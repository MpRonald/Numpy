...
# we can convert radians to degrees and vice versa as well in NumP.
...
# NumPy provides ufuncs arcsin(), arccos() and arctan() that produce radian 
# values for corresponding sin, cos and tan values given.
# Example
